                                    ...
                                    <form action="changepwd/currentpwd.php" method="POST" id="question-form" role="form">
                                        <div class="controls">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group"> <label ></label> <input type="text" name="currpassword" class="form-control" placeholder="current password" required="required" data-error="Question is required."> </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php
                                                if ($_GET["error"]== "fail") {
                                                    echo "<script type='text/javascript'>alert('This password is not correct. Please try again!');</script>";
